...
export default function NotificationSystem() {
  ...
  const { notifications, addNotification, removeNotification: removeNotif } = useNotification();
      ...
      >
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-bold text-secondary">Tambah Stok Cepat</h3>
            <button
              onClick={onClose}
          ...
          <div className="mb-4">
            <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Stok saat ini: {product.stok}</p>
              </div>
            </div>
          </div>
